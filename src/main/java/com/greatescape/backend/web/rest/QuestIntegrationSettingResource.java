...
import com.greatescape.backend.service.QuestIntegrationSettingQueryService;
import com.greatescape.backend.service.QuestIntegrationSettingService;
import com.greatescape.backend.service.dto.QuestIntegrationSettingCriteria;
...
/**
 * REST controller for managing {@link com.greatescape.backend.domain.QuestIntegrationSetting}.
 */
@RestController
@RequestMapping("/api")
public class QuestIntegrationSettingResource {
    ...
    public QuestIntegrationSettingResource(QuestIntegrationSettingService questIntegrationSettingService, QuestIntegrationSettingQueryService questIntegrationSettingQueryService) {
        this.questIntegrationSettingService = questIntegrationSettingService;
        this.questIntegrationSettingQueryService = questIntegrationSettingQueryService;
    }
