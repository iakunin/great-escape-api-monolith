...
import com.greatescape.backend.service.ThematicQueryService;
import com.greatescape.backend.service.ThematicService;
...
/**
 * REST controller for managing {@link com.greatescape.backend.domain.Thematic}.
 */
@RestController
@RequestMapping("/api")
public class ThematicResource {
    ...
    public ResponseEntity<ThematicDTO> getThematic(@PathVariable Long id) {
