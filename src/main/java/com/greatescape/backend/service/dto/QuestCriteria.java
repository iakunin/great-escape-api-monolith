...
/**
 * Criteria class for the {@link com.greatescape.backend.domain.Quest} entity. This class is used
 * in {@link com.greatescape.backend.web.rest.QuestResource} to receive all the possible filtering options from
