...
/**
 * Criteria class for the {@link com.greatescape.backend.domain.Company} entity. This class is used
 * in {@link com.greatescape.backend.web.rest.CompanyResource} to receive all the possible filtering options from
