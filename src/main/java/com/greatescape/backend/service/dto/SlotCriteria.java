...
/**
 * Criteria class for the {@link com.greatescape.backend.domain.Slot} entity. This class is used
 * in {@link com.greatescape.backend.web.rest.SlotResource} to receive all the possible filtering options from
