...
/**
 * Criteria class for the {@link com.greatescape.backend.domain.Player} entity. This class is used
 * in {@link com.greatescape.backend.web.rest.PlayerResource} to receive all the possible filtering options from
