...
/**
 * Criteria class for the {@link com.greatescape.backend.domain.Location} entity. This class is used
 * in {@link com.greatescape.backend.web.rest.LocationResource} to receive all the possible filtering options from
...
public class LocationCriteria implements Serializable, Criteria {
    ...
    public LongFilter getMetroId() {
        return metroId;
    }

    public void setMetroId(LongFilter metroId) {
