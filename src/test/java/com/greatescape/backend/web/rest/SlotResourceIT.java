...
import com.greatescape.backend.repository.SlotRepository;
import com.greatescape.backend.service.SlotQueryService;
import com.greatescape.backend.service.SlotService;
import com.greatescape.backend.service.dto.SlotDTO;
import com.greatescape.backend.service.mapper.SlotMapper;
import static com.greatescape.backend.web.rest.TestUtil.sameInstant;
...
public class SlotResourceIT {
    ...
    public void getAllSlots() throws Exception {
        ...
        restSlotMockMvc.perform(get("/api/slots?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dateTimeWithTimeZone").value(hasItem(sameInstant(DEFAULT_DATE_TIME_WITH_TIME_ZONE))))
    ...
    public void getSlot() throws Exception {
        ...
        restSlotMockMvc.perform(get("/api/slots/{id}", slot.getId()))
            ...
            .andExpect(jsonPath("$.dateTimeWithTimeZone").value(sameInstant(DEFAULT_DATE_TIME_WITH_TIME_ZONE)))
