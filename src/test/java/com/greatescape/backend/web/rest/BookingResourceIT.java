...
import com.greatescape.backend.service.BookingQueryService;
import com.greatescape.backend.service.BookingService;
...
public class BookingResourceIT {
    ...
    public void getAllBookingsByQuestIsEqualToSomething() throws Exception {
        ...
        defaultBookingShouldNotBeFound("questId.equals=" + (questId + 1));
    }
